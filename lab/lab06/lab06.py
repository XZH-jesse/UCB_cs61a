...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        before_balanced = self.balance
        self.balance = self.balance + amount
        transaction = Transaction(self.transactions_id, before_balanced, self.balance)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            transaction = Transaction(self.transactions_id, self.balance, self.balance)
            self.transactions_id += 1
            self.transactions.append(transaction)
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        "*** YOUR CODE HERE ***"     
        remove_coin = make_change(coin, self.coins)
        if remove_coin == None:
            return [coin]
        for c in remove_coin:
